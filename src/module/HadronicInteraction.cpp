                    ...
                    if (y < E and (Etot + Eout) < Eprimary) {
                        if (havePhotons) {
                            if (1. / Eout != 0.)  // BUG: some photons are produced with infinite energy!
                        	    candidate->addSecondary(22, Eout, pos, 1., tag);
                        }
                        Egamma += Eout;
                        Etot += Eout;
                        iTotal++;
        ...
        if (iNuMu1 <= NnuMu1) {
           if (end == -1) {
                do {
                    ...
                    if (y < E and (Etot + Eout) < Eprimary) {
                        if (haveNeutrinos)
                            candidate->addSecondary(14, Eout, pos, 1., tag);
                        EnuMu1 += Eout;
                        Etot += Eout;
                        iTotal++;
                        iNuMu1++;
        ...
        if (iElectron <= Nelectron) {
            if (end == -1) {
                do {
                    ...
                    if (y < E and (Etot + Eout) < Eprimary) {
                        if (haveElectrons)
                            candidate->addSecondary(11, Eout, pos, 1., tag);
                        Etot += Eout;
                        Eelectron += Eout;
                        iTotal++;
                        iElectron++;
        ...
        if (iNuE <= NnuE) {
            if (end == -1) {
                do {
                    ...
                    if (y < E and (Etot + Eout) < Eprimary) {
                        if (haveNeutrinos)
                            candidate->addSecondary(12, Eout, pos, 1., tag);
                        EnuE += Eout;
                        Etot += Eout;
                        iTotal++;
                        iNuE++;
